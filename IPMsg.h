...
/*  macro  */
//指令类型都为无符号长整型(unsigned long) 占四个字节
...
/*  command  *//*命令字*/
#define IPMSG_NOOPERATION		0x00000000UL/*不进行任何操作*/

#define IPMSG_BR_ENTRY			0x00000001UL /*用户上线*/
#define IPMSG_BR_EXIT			0x00000002UL/*用户退出*/
#define IPMSG_ANSENTRY			0x00000003UL/*通报在线*/
...
#define IPMSG_SENDMSG			0x00000020UL/*发送消息*/
#define IPMSG_RECVMSG			0x00000021UL/*通报收到消息*/
...
#define IPMSG_GETFILEDATA		0x00000060UL/*请求通过TCP传输文件*/
#define IPMSG_RELEASEFILES		0x00000061UL/*停止接收文件*/
#define IPMSG_GETDIRFILES		0x00000062UL/*请求传输文件夹*/

#define IPMSG_GETPUBKEY			0x00000072UL
#define IPMSG_ANSPUBKEY			0x00000073UL

/*  option for all command  */ /*选项位(32位命令字的高24位)*/
#define IPMSG_ABSENCEOPT		0x00000100UL
#define IPMSG_SERVEROPT			0x00000200UL
#define IPMSG_DIALUPOPT			0x00010000UL
#define IPMSG_FILEATTACHOPT		0x00200000UL/*传送文件选项*/
...
#define IPMSG_SENDCHECKOPT		0x00000100UL/*传送检查(需要对方返回确认信息)*/
...
/* file types for fileattach command *//*附件类型命令(文件类型命令字的低8位)*/
#define IPMSG_FILE_REGULAR		0x00000001UL /*普通文件*/
#define IPMSG_FILE_DIR			0x00000002UL/*目录文件*/
#define IPMSG_FILE_RETPARENT	0x00000003UL	// return parent directory 返回上一级目录
